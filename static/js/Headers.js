...
export async function appendUserHeader(page = "home") {
  ...
  h2.innerText = `Nickname: ${userD.Nickname}`;
  let h4 = document.createElement("h4");
  h4.innerText =`Email: ${userD.Email}`;
  let h42 = document.createElement("h4");
  h42.innerText = `Age: ${userD.Age}`;
  let h43 = document.createElement("h4");
  h43.innerText =  `Full Name: ${userD.FirstName} ${userD.LastName}`;
  ...
  icn1.innerHTML = `<svg class="icon home ${page==="home"? "active" : ""}"  width="24" height="24" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  icn2.innerHTML = `<svg class="icon liked  ${page==="liked"? "active" : ""}" "width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  icn3.innerHTML = `<svg class="icon created ${page==="created"? "active" : ""}"  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  logout.onclick = async()=> {await logUserOut()}
  icn2.onclick = ()=> {navigateTo("/liked")}
  icn3.onclick = ()=> {navigateTo("/created")}
  icn1.onclick = ()=> {navigateTo("/")}
